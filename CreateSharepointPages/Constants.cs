...
namespace CreateSharepointPages
{
    class Constants
    {
        internal class ConstantsHelper
        {
            ...
            public const string COMPANY_LIST_WEBPART = "ASTM.PPS.SharePointWebParts_ASTMPPSCompanyListWebPart.webpart";
            public const string CYCLE_MANAGEMENT_WEBPART = "ASTM.PPS.SharePointWebParts_ASTMPPSCycleManagementWebPart.webpart";
            public const string EDIT_COMPANY_WEBPART = "ASTM.PPS.SharePointWebParts_ASTMPPSEditCompanyWebPart.webpart";
            ...
            public const string CHANGE_PASSWORD_PAGE = "ChangePassword.aspx";
            public const string COMPANY_LIST_PAGE = "companylist.aspx";
            public const string COPY_FIELD_PAGE = "CopyFields.aspx";
            public const string COPY_METHOD_PAGE = "CopyMethod.aspx";
            public const string COPY_TEST_PAGE = "CopyTest.aspx";
            public const string DATA_COLLECTION_DATA_ENTRY_PAGE = "DataCollectionDataEntry.aspx";
            public const string DATA_COLLECTION_ENTRY_PAGE = "DataCollectionEntry.aspx";
            public const string DATA_COLLECTION_RESULT_PAGE = "DataCollectionResultPage.aspx";
            public const string DATA_COLLECTION_SUBMIT_PAGE = "DataCollectionSubmitPage.aspx";
            ...
            public const string MANAGE_RENEWALS_PAGE = "ManageRenewals.aspx";
            public const string MANAGE_TEST_PAGE = "ManageTest.aspx";
            public const string MYPROFILE_PAGE = "MyProfile.aspx";
            public const string PROGRAM_RESULT_UPLOAD_PAGE = "ProgramResultUpload.aspx";
